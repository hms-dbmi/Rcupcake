...
The `cooc.heatmap` function output is a heatmap. Blue color represents the lower values,  the red color represents the upper values. The co-occurrence measurement value is showed in each cell. 
