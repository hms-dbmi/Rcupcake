...
load("C:/Users/AG440/Desktop/genophenoPackage/inst/extdata/genopheno.RData")
queryExample
```
...
The `demographicSummary` function requires three arguments:
  * inputObject: the genopheno object.
...
phenotypeSummary(input      = queryExample,
                 mutation   = "CHD8", 
                 showTable  = TRUE, 
                 outputFile = TRUE)
```
...
genophenoComorCHD8no <- genoPhenoComorbidity( 
              input         = queryExample,
              pth           = "C:/Users/AG440/Desktop/genophenoPackage/inst/extdata/",
              aggregate    = FALSE, 
              ageRange      = c(4,18),
              gender        = "ALL", 
              mutation      = c("CHD8", "no")
