setMethod( "show",
           ...
           definition = function( object ) {
               ...
               cat( " . Number of Variations:   ", nrow ( object@variations ) , "\n" )
               cat( " . Number of Phenotypes:   ", nrow ( object@phenotypes ), "\n" )
               cat( " . Number of Patients:     ", length( unique ( object@iresult$patient_id ) ), "\n" )
           }
)
...
setMethod( "show",
           ...
           definition = function( object ) {
               ...
               cat( " . Patients with variation selected:", object@tpatients, "\n" )
