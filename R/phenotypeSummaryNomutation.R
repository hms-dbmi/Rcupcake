...
#' phenotypeSummaryNM( input     = genophenoExData, 
#'                  mutation   = "CHD8",
#'                  verbose    = FALSE 
#'            )
#' @export phenotypeSummaryNM

phenotypeSummaryNM <- function( input, mutation = FALSE, nfactor = 10, showTable = FALSE, path = "", verbose = FALSE ){
